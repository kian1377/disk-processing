...
r_offsets_fpath = data_dir/'psfs'/'spc_wide_psf_radial_samples.fits'
r_offsets_hdu.writeto(r_offsets_fpath, overwrite=True)

thetas_hdu = fits.PrimaryHDU(data=thetas.value)
thetas_fpath = data_dir/'psfs'/'spc_wide_psf_theta_samples.fits'
...
psfs_fpath = data_dir/'psfs'/'spc_wide_band4_polaxis{:d}_rtheta_v1.fits'.format(polaxis)
